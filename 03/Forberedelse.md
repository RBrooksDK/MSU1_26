<h1 align="center">Forberedelse før den første undervisning - Mængdelære</h1>
...
Brooks: [Kapitel 3](https://docs.google.com/viewer?url=https://raw.githubusercontent.com/RBrooksDK/MSE_book_v2/master/main.pdf).
...
[Noter fra videomateriale](https://viaucdk-my.sharepoint.com/:p:/g/personal/rib_viauc_dk/ETMONT97hChAg-qC90Qg6bwBwahu861wHnFZYHlY-gWz_Q?e=y6fFqJ)

[Andre materialer](https://viaucdk-my.sharepoint.com/:f:/g/personal/rib_viauc_dk/Esf4RiApcghJpRmy7bEe1G8B_1Ljm4UIQ35KHm9GY7qCWw?e=ricBRZ)
...
<?quiz?>
question: Hvilken af følgende mængdeoperationer repræsenterer "alle elementer der tilhører A eller B (eller begge)"?
answer: $A \cap B$
answer-correct: $A \cup B$
answer: $A \setminus B$
answer: $A \oplus B$
answer: $A^c$
content:
<p><strong>Forklaring:</strong> Unionen $A \cup B$ indeholder alle elementer der tilhører A eller B eller begge. Snittet $A \cap B$ indeholder kun elementer der tilhører både A og B.</p>
<?/quiz?>
